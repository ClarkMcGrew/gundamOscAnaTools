...
TABULATE_DEFINES+=" -DUseCUDAProb3=0 "
TABULATE_DEFINES+=" -DUseCUDAProb3Linear=0 "
TABULATE_DEFINES+=" -DUseOscProb=1 "
TABULATE_DEFINES+=" -DUseProb3ppLinear=1 "
TABULATE_DEFINES+=" -DUseNuFASTLinear=1 "
TABULATE_DEFINES+=" -DUseProbGPULinear=0 "
...
cmake -DCMAKE_INSTALL_PREFIX=${PWD} ${TABULATE_DEFINES} ${TABULATE_SOURCE}
make install
